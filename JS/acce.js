class Datos3 {
    constructor() {
        this.productos = [];
        this.agregarProductos(23, 'Colchoneta Antidesgaro', 13500,['XL','XLL' ],"colchonetaanti.jpg","Colchoneta");
        this.agregarProductos(24, 'Shampoo Duo', 2000,"","shampoo1.jpg","Higiene");
        this.agregarProductos(25, 'Pipeta', 800,"","pipeta3.jpg","Higiene");
        this.agregarProductos(26, 'Pretales', 4000,['S', 'M', 'L', 'XL','XLL' ],"Pretales.jpg","Pretal");
    }
